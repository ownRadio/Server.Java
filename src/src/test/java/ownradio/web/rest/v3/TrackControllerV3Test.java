...
// */
//public class TrackControllerV3Test {
...
//
//		mockMvc.perform(fileUpload("/api/v3/tracks")
//						.file(correctFile)
...
//
//		mockMvc.perform(get("/api/v3/tracks/{trackId}", TRACK_UUID).accept(MediaType.TEXT_PLAIN))
//				.andDo(print())
//				.andExpect(
//						status().isOk()
//				)
...
//
//		mockMvc.perform(get("/api/v3/tracks/{deviceId}/next", DEVICE_UUID))
//				.andDo(print())
//				.andExpect(
//						status().isOk()
//				)
...
//	}
//	@Test
//	public void getNextTrackIdV2() throws Exception {
//
//	}
//
//}